...
def talk_about_my_spirit_animal():
    ...
    type_of_animal = random.choice(['critical_animals','endangered_animals'])
    
    if (type_of_animal=='critical_animals'):
        animal_phrase = "The " + random.choice(type_of_animal) + "is my spirit animal. It's going to die out soon..."
    else:
        animal_phrase = "The " + random.choice(type_of_animal) + "is my spirit animal. It's extinct."
